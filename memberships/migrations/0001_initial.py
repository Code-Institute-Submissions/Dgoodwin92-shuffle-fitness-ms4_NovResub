    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_yearly', models.DecimalField(decimal_places=2,
                                                     max_digits=6)),
                ('price_monthly', models.DecimalField(decimal_places=2,
                                                      max_digits=6)),
                ('price_quarterly', models.DecimalField(decimal_places=2,
                                                        max_digits=6)),
