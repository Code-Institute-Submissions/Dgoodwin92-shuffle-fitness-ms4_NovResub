    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        if username != 'AnonymousUser':
            ...
            if save_info:
                ...
                profile.default_country__iexact = billing_details.address.\
                    country,
                profile.default_postcode__iexact = billing_details.address.\
                    postal_code,
                profile.default_town_or_city__iexact = billing_details.\
                    address.city,
                profile.default_street_address1__iexact = billing_details.\
                    address.line1,
                profile.default_street_address2__iexact = billing_details.\
                    address.line2,
